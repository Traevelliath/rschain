...
/// Returns the contract function signature, taking the first 4 Bytes of the keccak256 hash value.
...
impl From<bech32::primitives::hrp::Error> for TransactionError {
