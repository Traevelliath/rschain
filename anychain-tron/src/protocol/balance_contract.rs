...
impl<'a> Default for &'a FreezeBalanceContract {
...
impl<'a> Default for &'a UnfreezeBalanceContract {
...
impl<'a> Default for &'a WithdrawBalanceContract {
...
impl<'a> Default for &'a TransferContract {
...
impl<'a> Default for &'a TransactionBalanceTrace {
...
impl protobuf::Message for TransactionBalanceTrace {
    ...
    fn default_instance() -> &'static TransactionBalanceTrace {
        static instance: TransactionBalanceTrace = TransactionBalanceTrace {
            transaction_identifier: Vec::new(),
            operation: Vec::new(),
            type_: String::new(),
            status: String::new(),
            special_fields: protobuf::SpecialFields::new(),
...
pub mod transaction_balance_trace {
    ...
    impl<'a> Default for &'a Operation {
...
impl<'a> Default for &'a BlockBalanceTrace {
...
impl protobuf::Message for BlockBalanceTrace {
    ...
    fn default_instance() -> &'static BlockBalanceTrace {
        static instance: BlockBalanceTrace = BlockBalanceTrace {
            ...
            timestamp: 0,
            transaction_balance_trace: Vec::new(),
            special_fields: protobuf::SpecialFields::new(),
        };
        &instance
    }
...
pub mod block_balance_trace {
    ...
    impl<'a> Default for &'a BlockIdentifier {
...
impl<'a> Default for &'a AccountTrace {
...
impl<'a> Default for &'a AccountIdentifier {
...
impl<'a> Default for &'a AccountBalanceRequest {
...
impl<'a> Default for &'a AccountBalanceResponse {
...
impl<'a> Default for &'a FreezeBalanceV2Contract {
...
impl<'a> Default for &'a UnfreezeBalanceV2Contract {
...
impl<'a> Default for &'a WithdrawExpireUnfreezeContract {
...
impl<'a> Default for &'a DelegateResourceContract {
...
impl<'a> Default for &'a UnDelegateResourceContract {
...
impl<'a> Default for &'a CancelAllUnfreezeV2Contract {
...
pub fn file_descriptor() -> &'static protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            let mut messages = Vec::with_capacity(18);
            ...
            let mut enums = Vec::with_capacity(0);
