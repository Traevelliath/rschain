...
impl<'a> Default for &'a SmartContract {
    ...
    pub mod abi {
        ...
        pub mod entry {
            ...
            impl protobuf::Enum for EntryType {
                ...
                fn from_i32(value: i32) -> Option<EntryType> {
                    match value {
                        0 => Some(EntryType::UnknownEntryType),
                        1 => Some(EntryType::Constructor),
                        2 => Some(EntryType::Function),
                        3 => Some(EntryType::Event),
                        4 => Some(EntryType::Fallback),
                        5 => Some(EntryType::Receive),
                        6 => Some(EntryType::Error),
                        _ => None
                    }
                }

                fn from_str(str: &str) -> Option<EntryType> {
                    match str {
                        "UnknownEntryType" => Some(EntryType::UnknownEntryType),
                        "Constructor" => Some(EntryType::Constructor),
                        "Function" => Some(EntryType::Function),
                        "Event" => Some(EntryType::Event),
                        "Fallback" => Some(EntryType::Fallback),
                        "Receive" => Some(EntryType::Receive),
            ...
            impl protobuf::Enum for StateMutabilityType {
                ...
                fn from_i32(value: i32) -> Option<StateMutabilityType> {
                    match value {
                        0 => Some(StateMutabilityType::UnknownMutabilityType),
                        1 => Some(StateMutabilityType::Pure),
                        2 => Some(StateMutabilityType::View),
                        3 => Some(StateMutabilityType::Nonpayable),
                        4 => Some(StateMutabilityType::Payable),
                        _ => None
                    }
                }

                fn from_str(str: &str) -> Option<StateMutabilityType> {
                    match str {
                        "UnknownMutabilityType" => Some(StateMutabilityType::UnknownMutabilityType),
                        "Pure" => Some(StateMutabilityType::Pure),
                        "View" => Some(StateMutabilityType::View),
                        "Nonpayable" => Some(StateMutabilityType::Nonpayable),
                        "Payable" => Some(StateMutabilityType::Payable),
                        _ => None
                    }
                }
            ...
            impl Default for StateMutabilityType {
                fn default() -> Self {
                    StateMutabilityType::UnknownMutabilityType
                }
            }
...
impl<'a> Default for &'a ContractState {
...
impl<'a> Default for &'a CreateSmartContract {
...
impl<'a> Default for &'a TriggerSmartContract {
...
impl<'a> Default for &'a ClearABIContract {
...
impl<'a> Default for &'a UpdateSettingContract {
...
impl<'a> Default for &'a UpdateEnergyLimitContract {
...
impl<'a> Default for &'a SmartContractDataWrapper {
...
pub fn file_descriptor() -> &'static protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            let mut messages = Vec::with_capacity(11);
            ...
            let mut enums = Vec::with_capacity(2);
