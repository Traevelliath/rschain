...
pub struct AssetIssueContract {
    ...
    pub frozen_supply: Vec<asset_issue_contract::FrozenSupply>,
...
impl<'a> Default for &'a AssetIssueContract {
...
pub mod asset_issue_contract {
    ...
    impl<'a> Default for &'a FrozenSupply {
...
impl<'a> Default for &'a TransferAssetContract {
...
impl<'a> Default for &'a UnfreezeAssetContract {
...
impl<'a> Default for &'a UpdateAssetContract {
...
impl<'a> Default for &'a ParticipateAssetIssueContract {
