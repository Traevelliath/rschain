...
impl protobuf::Enum for ResourceCode {
    ...
    fn from_i32(value: i32) -> Option<ResourceCode> {
        match value {
            0 => Some(ResourceCode::BANDWIDTH),
            1 => Some(ResourceCode::ENERGY),
            2 => Some(ResourceCode::TRON_POWER),
            _ => None
        }
    }

    fn from_str(str: &str) -> Option<ResourceCode> {
        match str {
            "BANDWIDTH" => Some(ResourceCode::BANDWIDTH),
            "ENERGY" => Some(ResourceCode::ENERGY),
            "TRON_POWER" => Some(ResourceCode::TRON_POWER),
            _ => None
        }
    }
...
pub fn file_descriptor() -> &'static protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            let mut enums = Vec::with_capacity(1);
