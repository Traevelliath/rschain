...
impl<'a> Default for &'a AuthenticationPath {
...
pub struct MerklePath {
    ...
    pub authentication_paths: Vec<AuthenticationPath>,
...
impl<'a> Default for &'a MerklePath {
...
impl<'a> Default for &'a OutputPoint {
...
pub struct OutputPointInfo {
    ...
    pub out_points: Vec<OutputPoint>,
...
impl<'a> Default for &'a OutputPointInfo {
...
impl<'a> Default for &'a PedersenHash {
...
impl<'a> Default for &'a IncrementalMerkleVoucher {
...
pub struct IncrementalMerkleVoucherInfo {
    ...
    pub vouchers: Vec<IncrementalMerkleVoucher>,
...
impl<'a> Default for &'a IncrementalMerkleVoucherInfo {
...
impl<'a> Default for &'a SpendDescription {
...
impl<'a> Default for &'a ReceiveDescription {
...
impl<'a> Default for &'a ShieldedTransferContract {
...
impl protobuf::Message for ShieldedTransferContract {
    ...
    fn default_instance() -> &'static ShieldedTransferContract {
        static instance: ShieldedTransferContract = ShieldedTransferContract {
            ...
            from_amount: 0,
            spend_description: Vec::new(),
            receive_description: Vec::new(),
